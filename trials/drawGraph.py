...
def plot_graph(det_dic, aoa_out, freq_out, q1_m, q2_m, q3_m, q4_m, usr_scr):
    ...
    ax.scatter(q1_m[1], q1_m[0], marker="D", c="r", label="Q1 Avg")
    ax.scatter(q2_m[1], q2_m[0], marker="D", c="m", label="Q2 Avg")
    ax.scatter(q3_m[1], q3_m[0], marker="D", c="k", label="Q3 Avg")
    ax.scatter(q4_m[1], q4_m[0], marker="D", c="b", label="Q4 Avg")
    ax.scatter(usr_scr[1], usr_scr[0], marker="o", c="b", label="User's Score")
