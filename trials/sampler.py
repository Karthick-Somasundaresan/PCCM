...
def get_quad_data(dic):
    ...
    q1_data = {k: v for k, v in dic.iteritems() if v["Quad"] == "q1"}
    q2_data = {k: v for k, v in dic.iteritems() if v["Quad"] == "q2"}
    q3_data = {k: v for k, v in dic.iteritems() if v["Quad"] == "q3"}
    q4_data = {k: v for k, v in dic.iteritems() if v["Quad"] == "q4"}
